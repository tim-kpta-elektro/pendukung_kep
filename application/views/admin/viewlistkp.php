                    ...
                    <div class="block-content block-content-full">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-lg-6">
                                ...
                                <form class="mb-5" action="<?php echo base_url('admin/adminkp/updatelistkp'); ?>" method="POST">
                                ...
                                <h2 class="content-heading border-bottom mb-4 pb-2">Balasan Perusahaan</h2>
                                    ...
                                    <input type="text" class="form-control bg-white" id="flatpickr" name="tanggal_surat" value="<?php echo $data->tanggal_surat?>">
                                    </div>
                                    <div class="form-group">
