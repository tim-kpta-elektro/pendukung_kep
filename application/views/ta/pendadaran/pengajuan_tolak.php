            ...
            <div class="content">
                <div class="block">
                    <div class="block-header block-header-default">
                        <h1 class="block-title" style="text-align: center; color: red;">Pengajuan Pendadaran Anda <b>DITOLAK<b><br>Mohon Update Data Anda</h1>
                    </div>
                </div>
                <form action="<?php echo base_url('backend/pendadaran_ta/pengajuan_kembali') ?>" method="post">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content block-content-full">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12"> 
                                        <input type="text" class="form-control bg-white" id="flatpickr2" name="tanggal" value="<?php echo($tolak->tanggal)?>" placeholder="Y-m-d">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="jam mulai">Jam Mulai Pendadaran</label>
                                    <input type="text" class="form-control bg-white" name="jam_mulai" id="flatpickr" value="<?php echo($tolak->jam_mulai)?>" placeholder="Masukkan Jam Seminar Dimulai">
                                </div>
                                <div class="form-group">
                                    <label for="jam selesai">Jam Selesai Pendadaran</label>
                                    <input type="text" class="form-control bg-white" name="jam_selesai" id="flatpickr" value="<?php echo($tolak->jam_selesai)?>" placeholder="Masukkan Jam Seminar Selesai">
                                </div>
                                <div class="form-group">
                                    <label for="acceptor">Ruang:</label>
                                    <select class="form-control" name="tempat" id="">
                                        <option value="9" selected="selected" disabled><?php echo($tolak->nama_ruang)?></option>
