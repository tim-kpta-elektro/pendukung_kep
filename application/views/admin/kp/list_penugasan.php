                        ...
                        <div class="block-content block-content-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="<?php echo site_url('admin/adminkp/lihat_penugasankp/'.$row->nim) ?>" class="btn btn-sm btn-alt-info mr-5 mb-5"><i class="fa fa-eye"></i> View</a>
                                    <a href="<?php echo site_url('admin/adminkp/cetak_penugasankp/'.$row->nim) ?>" class="btn btn-sm btn-alt-secondary mr-5 mb-5" target="_blank"><i class="fa fa-print"></i> Cetak</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
