            ...
            <div class="content">
                <!-- <div class="block">
                    ...
                    <div class="block-header block-header-default">
                        ...
                        Pembimbing 1 - 
                        <=?php if($data->status_pem1 == 'PENDING'){?>
                            <span class="badge badge-danger">BELUM DISETUJUI</span>
                        <=?php } else if($data->status_pem1 == 'SETUJU') {?>
                            <span class="badge badge-success">DISETUJUI</span>
                        <=?php } ?> 
                        <br> Pembimbing 2 -  
                        <=?php if($data->status_pem2 == 'PENDING'){?>
                            <span class="badge badge-danger">BELUM DISETUJUI</span>
                        <=?php } else if($data->status_pem2 == 'SETUJU') {?>
                            <span class="badge badge-success">DISETUJUI</span>
                        <=?php } ?> </p>
                    </div>
                </div> -->
                <form action="<?php echo base_url('admin/adminta/update_pendaftaran') ?>" method="post">
                            ...
                            <div class="block-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="SETUJU" name="status_ta" hidden>
                                        <input type="text" class="form-control" value="SETUJU" name="status_pem1" hidden>
                                        <input type="text" class="form-control" value="SETUJU" name="status_pem2" hidden>
                                        <input type="text" class="form-control" value="<?php echo $data->id_ta?>" name="id_ta" hidden>  
                                        <div class="form-group row">
                                            <div class="col-lg-3 ml-auto">
                                                <button type="submit" class="btn btn-alt-primary">Setujui</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="block">
                            ...
                            <div class="block-content">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control "  name="peminatan" Value="<?php echo $data->nama_peminatan?>" readonly>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12" for="example-text-input">Judul</label>
                                        <div class="col-md-12">
                                            <textarea type="text" class="form-control" id="example-text-input" name="judul" rows="4" readonly><?php echo $data->judul?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12" for="example-text-input">Abstrak</label>
                                        <div class="col-md-12">
                                            <textarea type="text" class="form-control" id="example-text-input" name="abstrak" rows="4" readonly><?php echo $data->abstrak?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12" for="example-text-input">Tanggal Pengajuan</label>
                                        <div class="col-md-12"> 
                                            <input type="text" class="form-control"  name="tgl_pengajuan" value="<?php echo date("d-m-Y", strtotime($data->tgl_pengajuan))?>" readonly>
                                        </div>
                                    </div>
                            </div>
                        </div>
