                        ...
                        <div class="block-content block-content-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="<?php echo site_url('admin/adminkp/filekp/'.$row->file_balasan) ?>" class="btn btn-sm btn-alt-info mr-5 mb-5" target="_blank"><i class="fa fa-eye"> View</i></a>
                                    <a href="<?php echo site_url('admin/adminkp/lihatbalaskp/'.$row->nim) ?>" class="btn btn-sm btn-alt-warning mr-5 mb-5"><i class="fa fa-edit"> Update</i></a>
                                    <a href="<?php echo site_url('admin/adminkp/lihatbalaskp/'.$row->nim) ?>" class="btn btn-sm btn-alt-danger mr-5 mb-5"><i class="fa fa-times"> Tolak</i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
