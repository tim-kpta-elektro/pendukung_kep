        ...
        <footer>
            ...
            <table class="table1" style="width: 100%">    
                ...
                <tr>
                    ...
                    <td>Waktu KP</td>
                    <td>:</td>
                    <td><strong><?php echo date("d-m-Y", strtotime($data->rencana_mulai_kp))?> s/d <?php echo date("d-m-Y", strtotime($data->rencana_selesai_kp))?></strong></td>
                </tr>
            </table>
            <br>
            <table class="table2" style="width: 100%">
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 40%;">Surakarta, <?php echo date("d-m-Y", strtotime($data->tgl_ajuan))?><br>Yang mengajukan<br><br><br><br><b><?php echo $data->nama_mhs?></b><br><b>NIM. <?php echo $data->nim?></b></td>
                </tr>
            </table> 
         </div>     
      </div>
