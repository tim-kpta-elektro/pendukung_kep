                                            ...
                                            <tr>
                                                ...
                                                <td class="font-size-sm text-center">
                                                    ...
                                                    <?php if($status_ta == 'SETUJU'){?>
                                                        <span class="badge badge-success"><?php echo $row->status_ta?></span>
                                                    <?php } else if($status_ta == 'TOLAK') {?>
                                                        <span class="badge badge-danger"><?php echo $row->status_ta?></span>
                                                    <?php } else if($status_ta == 'PENDING') {?>
                                                        <span class="badge badge-warning"><?php echo $row->status_ta?></span>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
