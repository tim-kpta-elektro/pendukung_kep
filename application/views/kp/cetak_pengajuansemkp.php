        ...
        <footer>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 40%;">Surakarta, <?php date_default_timezone_set('Asia/Jakarta');echo date("d-m-Y"); ?><br>Pendaftar<br><br><br><br><b><?php echo $data->nama_mhs?></b><br><b>NIM. <?php echo $data->nim?></b></td>
                </tr>
            </table> 
         </div>     
      </div>
