            ...
            <main id="main-container">
                ...
                <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Daftar Pengajuan Seminar KP <small>Teknik Elektro</small></h3>
                        </div>
                        <div class="block-content block-content-full">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 40%;">Judul Seminar</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="<?php echo site_url('admin/adminkp/lihatseminar/'.$row->nim) ?>" class="btn btn-sm btn-warning">Update</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
