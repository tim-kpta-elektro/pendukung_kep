                            ...
                            <div class="col-md-8">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-content">
                                        <form action="<?php echo base_url('backend/kp/update_kp') ?>" method="post">
                                            <h2 class="content-heading border-bottom mb-4 pb-2">Data Diri</h2>
                                                ...
                                                <div class="form-group">
                                                    <input type="hidden" class="form-control" name="mahasiswa_id" value="<?php echo $tolak->id_mahasiswa ?>">
                                                </div>
                                            ...
                                            <h2 class="content-heading border-bottom mb-4 pb-2">Data Perusahaan</h2>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="perusahaan_nama" value="<?php echo $tolak->perusahaan_nama?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="alamat perusahaan">Alamat Perusahaan</label>
                                                    <input type="text" class="form-control" name="perusahaan_almt" value="<?php echo $tolak->perusahaan_almt?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="jenis usaha perusahaan">Jenis Usaha Perusahaan</label>
                                                    <input type="text" class="form-control" name="perusahaan_jenis" value="<?php echo $tolak->perusahaan_jenis ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="PIC">PIC</label>
                                                    <input type="text" class="form-control" name="pic" value="<?php echo $tolak->pic?>">
                                                </div>
