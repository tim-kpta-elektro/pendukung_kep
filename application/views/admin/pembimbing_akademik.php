                    ...
                    <div class="block-content block-content-full">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-lg-6">
                                ...
                                <form class="mb-5" action="<?php echo base_url('admin/admin/updatepem')?>" method="POST">
                                    <div class="form-group">
                                    <label for="pem_kp">Pembimbing Akademik</label>
                                    <select class="form-control selectpicker" name="pem_akademik" id="pem_akademik" onchange="autofill()" data-live-search="true">
