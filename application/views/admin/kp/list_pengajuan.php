                        ...
                        <div class="block-content block-content-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="<?php echo site_url('admin/adminkp/cetak_pengajuankp/'.$row->nim) ?>" class="btn btn-sm btn-alt-secondary mr-5 mb-5" target="_blank"><i class="fa fa-print"></i> Cetak</a>
                                    <a href="<?php echo site_url('admin/adminkp/lihat_pengajuankp/'.$row->nim) ?>" class="btn btn-sm btn-alt-warning mr-5 mb-5"><i class="fa fa-edit"></i> Update</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
