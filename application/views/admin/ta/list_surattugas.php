...
<head>
    <title>Portal Elektro - Surat Tugas TA</title>
                                    ...
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" style="width: 100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-size-sm text-center">
                                                    <a href="<?php echo site_url('admin/adminta/cetak_surattugas/'.$row->id_ta) ?>" class="btn btn-sm btn-alt-secondary mr-5 mb-5" target="_blank"><i class="fa fa-print"></i> Cetak</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
