            ...
            <ul class="nav-users push">
                <li>
                    <a href="be_pages_generic_profile.html">
                        <img class="img-avatar" src="<?php echo base_url();?>assets/media/avatars/avatar5.jpg" alt="">
                ...
                <li>
                    <a href="be_pages_generic_profile.html">
                        <img class="img-avatar" src="<?php echo base_url();?>assets/media/avatars/avatar14.jpg" alt="">
                ...
                <li>
                    <a href="be_pages_generic_profile.html">
                        <img class="img-avatar" src="<?php echo base_url();?>assets/media/avatars/avatar8.jpg" alt="">
