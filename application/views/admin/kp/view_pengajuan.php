    ...
    <body>
        <div id="page-container" class="sidebar-o enable-cookies sidebar-inverse enable-page-overlay side-scroll page-header-fixed page-header-modern main-content-boxed">
            ...
            <main id="main-container">
                ...
                <div class="content">
                <!-- <div class="mb-3"> 
                    <a href="<-?php echo base_url('admin/adminkp/cetak_pengajuankp/'.$data->nim)?>" class="btn btn-primary" target="_blank">Lembar Pengajuan KP</a>
                </div> -->
                <div class="block">
                    ...
                    <div class="block-content block-content-full">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-lg-6">
                                ...
                                <form class="mb-5" action="<?php echo base_url('admin/adminkp/update_pengajuankp'); ?>" method="POST">
                                ...
                                <h2 class="content-heading border-bottom mb-4 pb-2">Tanggal Pelaksanaan</h2>
                                    ...
                                    <label for="Tanggal Mulai">Tanggal Dimulai KP</label>
                                        <input type="text" class="js-datepicker form-control" id="example-datepicker3" name="tgl_mulai_kp" value="<?php echo $data->rencana_mulai_kp?>" readonly="readonly">
                                    </div>
                                    <div class="form-group">
                                    <label for="Tanggal Mulai">Tanggal Selesai KP</label>
                                        <input type="text" class="js-datepicker form-control" id="example-datepicker3" name="tgl_selesai_kp" value="<?php echo $data->rencana_selesai_kp?>" readonly="readonly">
                                    </div>
                                    <div class="form-group">
